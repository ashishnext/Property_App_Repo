...
<g:if test="${flash.search}">
    ...
    %{--<div class="container">--}%
    %{--<div class="row">--}%
    %{--<button type="button" class="btn btn-info btn-lg col-md-1" data-toggle="modal" data-target="#myModal">For Rent</button>--}%
                ...
                %{--<div class="modal-body">--}%
                    ...
                    %{--<g:form class="form-horizontal" controller="property" action="search"--}%
                        ...
                        %{--<div class="form-group row ">--}%
                            ...
                            %{--<g:select name="price" from="['0-5000', '5000-1000', '10000-15000', '15000-20000', '20000-30000']"--}%
                                      %{--noSelection="['': 'Select range']"/>--}%
                        %{--</div>--}%
