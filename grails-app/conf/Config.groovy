...
grails.plugin.springsecurity.successHandler.defaultTargetUrl = '/landing/home'
grails.plugin.springsecurity.auth.loginFormUrl = '/landing/login'
grails.plugin.springsecuritydefaultFailureUrl = '/landing/login'
